package com.example.angel.animation

/**
 * Created by angel on 3/1/2018.
 */
...
(context: Context) : View(context) {
    ...
    companion object {  //static stuff
        ...
        const val OVERSHOOT = 6 //Constant to indicate Overshoot animation
        const val ANTICIPATE_OVERSHOOT = 7 //Constant to indicate Anticipate Overshoot animation
